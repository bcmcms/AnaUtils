...
for bg in bgslice:
    ...
    if 'Combined' in bg:
        sigframe['A'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} diststtA.p",'rb'))[:,0]
        sigframe['B'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} diststtB.p",'rb'))
        sigframe['C'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} diststtC.p",'rb'))[:,0]
        bgframe['A'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} distbttA.p",'rb'))[:,0]
        bgframe['B'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} distbttB.p",'rb'))
        bgframe['C'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} distbttC.p",'rb'))[:,0]
        sigframe['F'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} diststtF.p",'rb'))[:,0]
        bgframe['F'] = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} distbttF.p",'rb'))[:,0]
        Fdat = pickle.load(open(f"{path}/BaseU/{sf} vs {bf} saveballF.p",'rb'))      
    else:
